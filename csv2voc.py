...
BASE_DIR = os.path.join('../', 'openimages')
OPEN_IMAGES_DIR = os.path.join(BASE_DIR, '2018_06')
print(OPEN_IMAGES_DIR)
download_enabled = False
trainval_enabled = True
hflip_enabled = True

def get_label_name(label_description):
    class_description_filename = os.path.join(OPEN_IMAGES_DIR, 'class-descriptions-boxable.csv')
...
def get_images_with_annotations(dataset_partition, label_names):
    images = {}
    annotations_filename = os.path.join(OPEN_IMAGES_DIR, dataset_partition, 'validation-annotations-bbox.csv')
...
def download_images(dataset_partition, image_ids):
    images_filename = os.path.join(OPEN_IMAGES_DIR, dataset_partition, 'validation-images-with-rotation.csv')
