...
#指定找到文件后，移动为的文件夹路径
outDir = os.path.abspath('/media/cloud/wwq/openimages/openimages/VOCify/AJ') 

#指定第一个文件夹的位置
imageDir1 = os.path.abspath('/media/cloud/wwq/openimages/openimages/VOCify/JPEGImages')
...
#对于第二个文件夹路径，做同样的操作
imageDir2 = os.path.abspath('/media/cloud/wwq/openimages/openimages/VOCify/Annotations')
image2 = []
imgname2 = []
...
for item1 in imgname1:
    for item2 in imgname2:
        if item1 == item2:
            ...
            shutil.move(os.path.join(imageDir1, name),outDir)
